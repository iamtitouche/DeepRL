...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'DuelingDDQN')))
from dueling_ddqn import AgentDuelingDDQN
...
def main(cfg: DictConfig, config_path: str):
    ...
    ddqn = AgentDuelingDDQN(hyperparameters)
