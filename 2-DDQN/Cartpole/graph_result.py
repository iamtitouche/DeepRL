...
def plot_rewards(dirname):
    ...
    filename = f'{dirname}/rewards.txt'
    ...
    plt.legend()
    plt.savefig(f"{dirname}/rewards.png", format="png")
    plt.show()


plot_rewards("Training_Data_1")
plot_rewards("Training_Data_2")
plot_rewards("Training_Data_3")
plot_rewards("Training_Data_4")
plot_rewards("Training_Data_5")
plot_rewards("Training_Data_6")
