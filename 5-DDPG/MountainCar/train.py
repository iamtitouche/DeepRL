...
from wrapper import MountainCar
from MountainCar_Processing import state_preprocess, get_initial_state
import argparse
...
def main(cfg: DictConfig, config_path: str):
    env = MountainCar(cfg.environment.render_mode, cfg.environment.reward_mode)
